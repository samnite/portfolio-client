    ...
    resources: {
      en: {
        translation: {
          ...
          bio:
            "I’m Ukraine-based developer. I work for clients all over the world. " +
            "I specialize in front-end development, and I love what I do.",
          hi: "Hi, I'm ",
          languages: [],
      ...
      ua: {
        translation: {
          ...
          bio:
            "Я – український девелопер, співпрацюючий з клієнтами з усього світу. " +
            "Моя спеціалізація – розробка інтерфейсів. Любов до свого діла дозволяє мені досягати кращих результатів, вирішувати найскладніші задачі, втілювати в життя будь-які ідеї.",
          hi: "Привіт, я ",
          ...
          aboutBody3:
            "Я високомотивований розробник, який ставиться з увагою до деталей, має тверді етичні переконання. Надішліть мені електронного листа, і давайте обговоримо усі деталі проєкту. Буду радий застосувати свої досвід та знання в роботі над вашим продуктом!",
          homeNavLink: "Головна",
          aboutNavLink: "Про мене",
          projectsNavLink: "Проєкти",
          ...
          srcTitle: "Код",
          seeSrcTitle: "Дивитись проєкт на GitHub",
      ...
      ru: {
        translation: {
          ...
          bio:
            "Я – украинский девелопер, сотрудничающий с клиентами со всего мира. Моя специализация – разработка интерфейсов. " +
            "Любовь к своему делу позволяет мне добиваться наилучших результатов, решать самые сложные задачи, воплощать в жизнь любые идеи.",
          hi: "Привет, я ",
